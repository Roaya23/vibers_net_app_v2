...
class AppButton extends StatelessWidget {
  ...
  final List<Widget>? Function(
          BuildContext context, bool isEnabled, bool isLoading, Widget text)?
      childrenBuilder;
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          disabledBackgroundColor:
              disableButtonColor ?? buttonColor.withOpacity(.3),
                    ...
                    Flexible(
                      child: FittedBox(
                        ...
                        child: Text(
                          text,
                          style:
                              textStyle ?? TextStyles.bold16(color: textColor),
                          textAlign: TextAlign.center,
                          maxLines: 1,
                        ),
                      ),
          ...
          children: (childrenBuilder != null)
              ? childrenBuilder!(
                  ...
                  Text(
                    text,
                    style: textStyle ??
                        TextStyles.regular16(color: textStateColor),
                    textAlign: TextAlign.center,
                    maxLines: 1,
                  ),
                )!
